...
public class LinkedQueue<T> {
    ...
    public T dequeue() {
        if (size == 0) {
            throw new NoSuchElementException("There is no data to remove from empty queue.");
        }
    ...
    public T peek() {
        if (size == 0) {
            throw new NoSuchElementException("The data cannot be returned from empty queue.");
        }
        return head.getData();
    }
